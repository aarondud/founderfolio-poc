...
export const NotFound: React.FC = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 pb-16">
      ...
      >
        <Tag icon={AlertTriangle} text="404 - PAGE NOT FOUND" />
      </div>

      <div
        className={`bg-card rounded-xl shadow-lg p-8 md:p-12 opacity-0 ${
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
            ...
            moved or deleted. Use the button below to return to the main
            FounderFolio experience.
          </p>
